              ...
              {activeStep === 0 && (
                <div className="space-y-3 sm:space-y-0 sm:grid sm:gap-4 sm:grid-cols-2 lg:gap-6">
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3 sm:rounded-2xl sm:p-6">
                    <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-zinc-400 sm:text-xs">
                      Step 01
                    </p>
                    ...
                    <div className="mt-3 rounded-lg border border-zinc-800 bg-zinc-950/70 p-2.5 sm:mt-6 sm:rounded-xl sm:p-4">
                      <p className="font-mono text-[10px] text-zinc-400 sm:text-xs">Core command</p>
                  ...
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3 sm:rounded-2xl sm:p-6">
                    ...
                    <div className="mb-2 rounded-lg border border-zinc-800 bg-zinc-950/70 p-2.5 sm:mb-4 sm:rounded-xl sm:p-4">
                      <p className="font-mono text-[10px] text-zinc-400 sm:text-xs">Config path</p>
                      <p className="mt-0.5 break-all text-[11px] text-zinc-300 sm:mt-1 sm:text-sm">{currentClient.path}</p>
                      <span className="mt-1.5 inline-block rounded-full border border-zinc-800 bg-black px-2 py-0.5 font-mono text-[9px] uppercase tracking-[0.14em] text-zinc-400 sm:mt-3 sm:px-2.5 sm:py-1 sm:text-[10px]">
                        Transport: stdio
                      </span>
                    </div>
              ...
              {activeStep === 1 && (
                <div className="space-y-3 sm:space-y-0 sm:grid sm:gap-4 sm:grid-cols-2 lg:gap-6">
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3 sm:rounded-2xl sm:p-6">
                    ...
                    <div className="mt-3 rounded-lg border border-zinc-800 bg-zinc-950/70 p-2.5 sm:mt-6 sm:rounded-xl sm:p-4">
                      <p className="font-mono text-[10px] text-zinc-400 sm:text-xs">Quick test</p>
                  ...
                  <div className="overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950/70 sm:rounded-2xl">
                    <div className="flex items-center justify-between border-b border-zinc-800/80 px-2.5 py-1.5 sm:px-4 sm:py-3">
                      <div className="flex items-center gap-1.5 sm:gap-2">
                        <PlugZap className="h-3.5 w-3.5 text-zinc-400 sm:h-4 sm:w-4" />
                        <span className="font-mono text-[10px] text-zinc-400 sm:text-xs">
                          connection.log
                        </span>
                      </div>
                      <span className="rounded-full border border-zinc-800 bg-black px-1.5 py-0.5 font-mono text-[9px] uppercase tracking-[0.14em] text-zinc-400 sm:px-2.5 sm:py-1 sm:text-[10px]">
                        Connected
                      </span>
                    </div>
                    <div className="space-y-1.5 p-2.5 font-mono text-[11px] leading-5 text-zinc-300 sm:space-y-3 sm:p-5 sm:text-sm sm:leading-7">
                      {diagnosticLines.map((line) => (
                        <div key={line} className="flex gap-1.5 sm:gap-3">
                          <TerminalSquare className="mt-0.5 h-3.5 w-3.5 shrink-0 text-zinc-400 sm:h-4 sm:w-4" />
                          <span>{line}</span>
                        </div>
                      ))}
                    </div>
                ...
                <div className="space-y-3 sm:space-y-0 sm:grid sm:gap-4 sm:grid-cols-2 lg:gap-6">
                  <div className="rounded-xl border border-zinc-800 bg-black/40 p-3 sm:rounded-2xl sm:p-6">
                    ...
                    <div className="mt-3 overflow-hidden rounded-lg border border-zinc-800 bg-zinc-950/70 p-2.5 sm:mt-6 sm:rounded-xl sm:p-4">
                      <p className="font-mono text-[10px] text-zinc-400 sm:text-xs">Generated topics</p>
                  ...
                  <div className="overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950/70 sm:rounded-2xl">
                    <div className="flex items-center justify-between gap-2 border-b border-zinc-800/80 px-2.5 py-1.5 sm:px-4 sm:py-3">
                      <span className="truncate rounded-md border border-zinc-800 bg-black px-1.5 py-0.5 font-mono text-[10px] text-zinc-400 sm:px-3 sm:py-1 sm:text-xs">
                        bootstrap-prompt.md
                      </span>
                      <CopyButton
                    ...
                    <div className="overflow-x-auto p-2.5 font-mono text-[11px] leading-5 text-zinc-300 sm:p-5 sm:text-sm sm:leading-7">
                      {bootstrapPrompt.split("\n").map((line, index) => (
                        <div key={`${index}-${line}`} className="flex">
                          <span className="mr-2 inline-block w-5 shrink-0 select-none text-right text-zinc-400 sm:mr-4 sm:w-8">
                            {String(index + 1).padStart(2, "0")}
                          </span>
