  ...
  return (
    <section className="relative overflow-hidden">
      <div className="relative mx-auto max-w-6xl px-6 pt-24 pb-20 md:pt-32 md:pb-28">
        ...
        >
          <Link href={"https://github.com/slxca/opencontext/releases/tag/v1.3.0"} target={"_blank"} className="inline-flex items-center gap-1.5 rounded-full border border-zinc-800 bg-zinc-900/80 px-3 py-1 font-mono text-[10px] uppercase tracking-wider text-zinc-300 transition-colors hover:border-zinc-700 hover:bg-zinc-800/80 sm:text-[11px]">
            <GitBranch className="h-3 w-3" />
            v1.3.0 Released — Http transport & init command
          </Link>
        </motion.div>
